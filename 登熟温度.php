...
$table = "CREATE TABLE average_temp AS select from_days(to_days(date)) 日付, avg(temp) 平均気温 from atmos where date between '2022-08-08' and '2022-09-15' group by from_days(to_days(date));";
// queryを実行し、結果を変数に格納
$sql = $db->query($table);
